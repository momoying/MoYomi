...
TEMPLATES = {
    "main": str(PROJECT_ROOT / "Daily" / "CoopReward" / "explore.png"),
    "store_entry": str(SCRIPT_DIR / "store_entry.png"),
    "menu_scroll": str(SCRIPT_DIR / "menu_scroll.png"),
    "consignment_entry": str(SCRIPT_DIR / "consignment_entry.png"),
    "exchange_inactive": str(SCRIPT_DIR / "exchange_inactive.png"),
    "exchange_active": str(SCRIPT_DIR / "exchange_active.png"),
    "consignment_ticket": str(SCRIPT_DIR / "consignment_ticket.png"),
    "purchase_dialog": str(SCRIPT_DIR / "purchase_dialog.png"),
    "max_quantity": str(SCRIPT_DIR / "max_quantity.png"),
    "purchase": str(SCRIPT_DIR / "purchase.png"),
...
REGIONS = {
    "main": ((500, 80), (800, 280)),
    "store_entry": ((550, 560), (850, 720)),
    "menu_scroll": ((1100, 540), (1280, 720)),
    "consignment_entry": ((150, 600), (330, 720)),
    "exchange_inactive": ((1140, 250), (1280, 450)),
    "exchange_active": ((1140, 250), (1280, 450)),
    # 未购买时固定在第一行第三格；限制区域可避免命中其他券图案。
    "consignment_ticket": ((550, 130), (900, 380)),
    "purchase_dialog": ((450, 450), (850, 650)),
    "max_quantity": ((700, 380), (850, 520)),
    "purchase": ((500, 480), (780, 620)),
    "reward": ((350, 130), (900, 330)),
    "courtyard_back": ((60, 0), (190, 100)),
}
...
MATCH_THRESHOLDS = {
    ...
    "store_entry": 0.88,
    "menu_scroll": 0.80,
    "consignment_entry": 0.90,
    "exchange_inactive": 0.94,
    "exchange_active": 0.96,
    "consignment_ticket": 0.92,
    "purchase_dialog": 0.94,
    "max_quantity": 0.94,
    "purchase": 0.94,
    "reward": 0.92,
    "courtyard_back": 0.90,
