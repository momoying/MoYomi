...
from tasks.HeartTeam.assets import HeartTeamAssets

ASSETS = HeartTeamAssets
TEMPLATES = ASSETS.TEMPLATES
REGIONS = ASSETS.REGIONS
MATCH_THRESHOLD = ASSETS.MATCH_THRESHOLD
MATCH_THRESHOLDS = ASSETS.MATCH_THRESHOLDS
AWAKENING_RALLY_BUTTON = ASSETS.AWAKENING_RALLY_BUTTON
AWAKENING_CATEGORY_BUTTON = ASSETS.AWAKENING_CATEGORY_BUTTON
CREATE_TEAM_BUTTON = ASSETS.CREATE_TEAM_BUTTON
LEVEL_LIST_BOUNDS = ASSETS.LEVEL_LIST_BOUNDS
LEVEL_OPTION_VERTICAL_PADDING = ASSETS.LEVEL_OPTION_VERTICAL_PADDING
VICTORY_TRANSITION_CLICK_AREA = ASSETS.VICTORY_TRANSITION_CLICK_AREA
REWARD_BLANK_AREAS = ASSETS.REWARD_BLANK_AREAS
STAMINA_TEXT_REGION = ASSETS.STAMINA_TEXT_REGION
MEMBER_SLOTS = ASSETS.MEMBER_SLOTS
