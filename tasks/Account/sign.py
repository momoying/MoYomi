...
from tasks.Account.assets import SignAssets

ASSETS = SignAssets
TEMPLATES = ASSETS.TEMPLATES
REGIONS = ASSETS.REGIONS
ENTER_GAME_TEXT_REGION = ASSETS.ENTER_GAME_TEXT_REGION
ENTER_GAME_CLICK_REGION = ASSETS.ENTER_GAME_CLICK_REGION
SERVER_TEXT_REGION = ASSETS.SERVER_TEXT_REGION
REGION_SWITCH_CLICK_REGION = ASSETS.REGION_SWITCH_CLICK_REGION
REGION_CARD_CLICK_REGIONS = ASSETS.REGION_CARD_CLICK_REGIONS
REGION_CARD_NAME_OCR_REGIONS = ASSETS.REGION_CARD_NAME_OCR_REGIONS
MATCH_THRESHOLD = ASSETS.MATCH_THRESHOLD
VALID_REGIONS = ASSETS.VALID_REGIONS
...
def _save_timeout_screenshot(stage: str, frame=None) -> Optional[Path]:
    saved_path = capture_error_screenshot("account_sign", stage, frame=frame)
    if saved_path is not None:
        print(f"登录报错截图已保存: {saved_path}")
