...
BATTLE_PREPARE_TEMPLATE = SCRIPT_DIR / "battle_prepare.png"
BATTLE_PREPARE_THRESHOLD = 0.82
BATTLE_PREPARE_REGION = ((0, 0), (1280, 720))
BATTLE_REWARD_TEMPLATE = SCRIPT_DIR / "battle_reward.png"
BATTLE_REWARD_THRESHOLD = 0.82
BATTLE_REWARD_REGION = ((0, 0), (1280, 720))
BATTLE_REWARD_BLANK_AREAS = {
    "左侧": (30, 160, 210, 650),
    "右侧": (1070, 160, 1250, 650),
}
...
# “确认跳过”是剧情跳过按钮触发的模态弹窗，必须先处理；其余动作继续
# 遵循用户指定的优先级。元组顺序就是点击优先级，禁止按其他字段排序。
ACTIONS = (
    StoryAction(
        "confirm_skip",
        "确认跳过",
        SCRIPT_DIR / "confirm_skip.png",
        (0, 0),
        (1280, 720),
    ),
    StoryAction(
