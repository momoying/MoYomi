...
TEMPLATES = {
    ...
    "task_list": str(SCRIPT_DIR / "flag.png"),
    "one_tap": str(SCRIPT_DIR / "finish.png"),
    "back": str(SCRIPT_DIR / "back.png"),
    "sign_in_close": str(SCRIPT_DIR / "sign_in_close.png"),
    "reward_success": str(SCRIPT_DIR / "reward_success.png"),
    "completed": str(SCRIPT_DIR / "completed.png"),
}
REGIONS = {
    "main": ((500, 80), (800, 280)),
    # 屏幕中间水平线到好友等底部功能栏顶端之间的整块区域。
    "task_list": ((0, 360), (1280, 590)),
    "one_tap": ((1030, 520), (1280, 720)),
    "back": ((0, 0), (120, 100)),
    "sign_in_close": ((760, 40), (980, 190)),
    "reward_success": ((240, 0), (600, 120)),
    # 日常页最上方任务右侧的“已完成”印章。
    "completed": ((900, 100), (1140, 240)),
}
...
DAILY_TAB_CLICK_REGION = (1140, 120, 1210, 205)
