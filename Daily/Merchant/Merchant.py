...
TEMPLATES = {
    ...
    "popular_marker": str(SCRIPT_DIR / "popular_marker.png"),
    "shop_back": str(SCRIPT_DIR / "shop_back.png"),
    "merchant_entry": str(SCRIPT_DIR / "merchant_entry.png"),
    "blue_ticket": str(SCRIPT_DIR / "blue_ticket.png"),
    "blue_ticket_special": str(SCRIPT_DIR / "blue_ticket_special.png"),
    "refresh": str(SCRIPT_DIR / "refresh.png"),
...
REGIONS = {
    ...
    "popular_marker": ((100, 0), (380, 100)),
    "shop_back": ((0, 0), (100, 100)),
    "merchant_entry": ((0, 350), (180, 600)),
    "blue_ticket": ((100, 80), (1050, 580)),
    "refresh": ((1120, 450), (1280, 650)),
    "confirm": ((550, 350), (920, 520)),
    "courtyard_back": ((60, 0), (180, 100)),
}

PRICE_TEMPLATES = {
    "50": str(SCRIPT_DIR / "price_50.png"),
    "70": str(SCRIPT_DIR / "price_70.png"),
    "80": str(SCRIPT_DIR / "price_80.png"),
    "90": str(SCRIPT_DIR / "price_90.png"),
}
