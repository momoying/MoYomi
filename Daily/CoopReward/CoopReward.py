...
TEMPLATES = {
    "main": str(SCRIPT_DIR / "explore.png"),
    "soul_entry": str(SCRIPT_DIR / "soul_entry.png"),
    "dungeon_card": str(SCRIPT_DIR / "dungeon_card.png"),
    "floor10_active": str(SCRIPT_DIR / "floor10_active.png"),
    "floor10_inactive": str(SCRIPT_DIR / "floor10_inactive.png"),
    "formation_locked": str(SCRIPT_DIR / "formation_locked.png"),
    "formation_unlocked": str(SCRIPT_DIR / "formation_unlocked.png"),
    "bonus_lantern": str(SCRIPT_DIR / "bonus_lantern.png"),
    "soul_bonus": str(SCRIPT_DIR / "soul_bonus.png"),
    "bonus_start": str(SCRIPT_DIR / "bonus_start.png"),
...
REGIONS = {
    "main": ((500, 80), (800, 280)),
    "soul_entry": ((0, 570), (180, 720)),
    "dungeon_card": ((0, 60), (380, 650)),
    "floor10_active": ((50, 80), (280, 700)),
    "floor10_inactive": ((50, 80), (280, 700)),
    "formation_locked": ((600, 560), (820, 720)),
    "formation_unlocked": ((600, 560), (820, 720)),
    "bonus_lantern": ((350, 0), (520, 120)),
    "soul_bonus": ((300, 100), (960, 550)),
    "bonus_start": ((750, 100), (930, 520)),
...
MATCH_THRESHOLDS = {
    ...
    "dungeon_card": 0.80,
    "floor10_active": 0.90,
    "floor10_inactive": 0.90,
    "formation_locked": 0.88,
    "formation_unlocked": 0.85,
    "bonus_lantern": 0.90,
    "soul_bonus": 0.90,
    "bonus_start": 0.90,
    "challenge": 0.90,
...
def _ensure_floor10_active() -> bool:
    ...
    while time.monotonic() < deadline:
        ...
        utils.adb_swipe(start_x, start_y, end_x, end_y, duration_ms=800)
        time.sleep(0.8)
