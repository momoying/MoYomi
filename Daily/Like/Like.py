...
TEMPLATES = {
    ...
    "friend": str(SCRIPT_DIR / "friend.png"),
    "menu_scroll": str(SCRIPT_DIR / "menu_scroll.png"),
    "friend_collapsed": str(SCRIPT_DIR / "friend_collapsed.png"),
    "friend_expanded": str(SCRIPT_DIR / "friend_expanded.png"),
    "like": str(SCRIPT_DIR / "Like.png"),
    "liked": str(SCRIPT_DIR / "Liked.png"),
    "back": str(SCRIPT_DIR / "back.png"),
}

REGIONS = {
    "main": ((500, 80), (800, 280)),
    "friend": ((700, 560), (1050, 710)),
    "menu_scroll": ((1100, 540), (1280, 720)),
    "friend_collapsed": ((430, 145), (495, 195)),
    "friend_expanded": ((430, 145), (495, 195)),
    "like": ((500, 70), (850, 270)),
    "liked": ((500, 70), (850, 270)),
    "back": ((1100, 50), (1240, 180)),
}
