...
from module.assets import StartupAssets, StartupMatchSpec as MatchSpec
...
SPECS = ASSETS.SPECS
SAFE_ROOM_STATES = ASSETS.SAFE_ROOM_STATES
ROOM_EXIT_CONFIRM_STATES = ASSETS.ROOM_EXIT_CONFIRM_STATES
...
def _save_screenshot(stage: str, frame=None) -> Optional[str]:
    return capture_error_screenshot("startup_recovery", stage, frame=frame)
...
if __name__ == "__main__":
    from tasks.Exp.exp_monster import collect_battle_rewards
    from tasks.Account.switch import exit_to_login
